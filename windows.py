...
class CodeTypingBot:
    ...
    def monitor_clipboard_and_type(self):
        ...
        model = genai.GenerativeModel(
            ...
            system_instruction=f"Output ONLY {self.lang_var.get()} code without comments or indentation. Add new lines where necessary.Do not make the class public in java and use Scanner for taking input in java."
        )
